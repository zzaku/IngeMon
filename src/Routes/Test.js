...
function Test() {
  ...
  useEffect(() => {
    ...
    fetch(
      "http://localhost:4000/performances/60fe7660c1bdfd3cf80dd8bb",
      requestOptions
    );
  }, []);
  ...
  return (
    <div className="container-performances">
      <h2>Testez les performances de vos composants !</h2>
      <ul className="BarNav-test">
        <li className="BarNav-composant">
      ...
      <Monitoring
        postChild={post}
        setPostChild={setPost}
        btnChild={btn}
        setBtnChild={setBtn}
        dataArray={dataArray}
        setDataArray={setDataArray}
        dataArray1={dataArray1}
        setDataArray1={setDataArray1}
        dataArray2={dataArray2}
        setDataArray2={setDataArray2}
      />
    </div>
  );
}
